...
export function Footer() {
  ...
  return (
    <footer className="relative bg-black border-t border-white/10 text-gray-300">
      {/* Background Subtle Effects */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary/10 rounded-full blur-[120px] opacity-20" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-primary/5 rounded-full blur-[120px] opacity-10" />
      </div>
          ...
          <div className="space-y-6 lg:col-span-1">
            <div className="space-y-4">
              <Image
                ...
                height={200}
                alt="Protonix It"
                className="h-auto w-auto max-w-[180px] brightness-110"
              />
            ...
            <div className="flex gap-3 pt-2">
              {[
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-white/5 text-gray-400 hover:bg-primary hover:text-white transition-all duration-300 hover:scale-110"
                  aria-label={label}
                >
                  <Icon size={18} />
                </Link>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={label}>
                    <Link
                      href={href}
                      className="text-sm text-gray-400 hover:text-primary transition-colors duration-300 flex items-center gap-1 group"
                    >
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a
                    ...
                    className="flex gap-3 text-sm text-gray-400 hover:text-white transition-colors duration-300 group"
                  >
                    <Mail
                      size={18}
