const benefits = [
  {
    ...
    description:
      "একটি পেশাদার ওয়েবসাইট ভোটার এবং নাগরিকদের কাছে আপনার নেতৃত্ব ও বিশ্বাসযোগ্যতা প্রতিষ্ঠা করে।",
  },
  {
    title: "আপনার বার্তা ছড়িয়ে দিন",
    description:
      "আপনার দৃষ্টিভঙ্গি, নীতি ও অর্জন নিরাপদ ও প্রভাবশালীভাবে জনগণের কাছে পৌঁছে দিন।",
  },
  {
    title: "প্রচারাভিযান প্রচার করুন",
    description:
      "আপনার প্রচারাভিযান, আসন্ন ইভেন্ট এবং উদ্যোগ ভোটারদের কাছে দক্ষতার সঙ্গে পৌঁছে দিন।",
  },
  {
    title: "ভোটার যোগাযোগ",
    description:
